...
if [ -f "tests/security.spec.js" ]; then
  ...
  # Use Node.js for robust patching (works on all platforms)
  node -e "
const fs = require('fs');
const path = 'tests/security.spec.js';
let content = fs.readFileSync(path, 'utf8');
// Insert env line after executablePath
...
"
  ...
  echo "⚠️ tests/security.spec.js not found – skipping patch. Make sure your tests set EICIEL_TEST_MODE=1 in the env."
fi
